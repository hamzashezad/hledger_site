...
- shipped with [web](web.md), [terminal](ui.md), [command line](basics.md), [JSON](https://hledger.org/hledger-web.html#json-api) and [Haskell](https://hackage.haskell.org/package/hledger-lib) interfaces
